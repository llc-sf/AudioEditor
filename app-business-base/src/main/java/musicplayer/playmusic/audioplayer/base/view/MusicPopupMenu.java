...
public class MusicPopupMenu extends PopupWindow {
    ...
    public MusicPopupMenu(Context context) {
        ...
        setBackgroundDrawable(ResourceUtils.getAttrDrawable(context, R.attr.popupMenuBackground));
        ...
        setFocusable(true);
        setTouchable(true);
        if (ViewUtils.isRtl(mRootView)) {
            setAnimationStyle(R.style.MusicPopWindowAnim_Rtl);
        } else {
            setAnimationStyle(R.style.MusicPopWindowAnim);
        }
    }
