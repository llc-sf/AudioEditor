...
function link_one_ffmpeg() {
  ...
  -lc -lm -lz -ldl -llog -landroid --dynamic-linker=/system/bin/linker $TOOL/lib/gcc/i686-linux-android/4.9.x/libgcc.a $TOOL/lib/gcc/i686-linux-android/4.9.x/libgcc_real.a
}
