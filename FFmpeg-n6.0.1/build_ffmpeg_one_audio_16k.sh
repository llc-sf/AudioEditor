...
if [ $archbit -eq 32 ];then
  ...
  export EXTRA_LDFLAGS="-lc -lm -ldl -llog -lgcc -lz -landroid -L$THIRD_LIB/lib -L/Users/chenlu/AndroidStudioProjects/AudioEditor/lame-3.100/android/arm/lib -Wl,-z,max-page-size=16384 -Wl,-z,common-page-size=16384"
else
  ...
  export EXTRA_LDFLAGS="-lc -lm -ldl -llog -lgcc -lz -landroid -L$THIRD_LIB/lib -L/Users/chenlu/AndroidStudioProjects/AudioEditor/lame-3.100//android/aarch64/lib -Wl,-z,max-page-size=16384 -Wl,-z,common-page-size=16384"
fi
...
function link_one_ffmpeg() {
  ...
  -Wl,-z,max-page-size=16384 -Wl,-z,common-page-size=16384 -Wl,-Bsymbolic -Wl,--no-undefined -Wl,-soname,libffmpeg.so \
  ...
  -Wl,--no-whole-archive -lc -lm -lz -ldl -llog -landroid
}
