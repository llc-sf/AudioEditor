 ...
 * 圆角Button
 */
public class AutoFitCornersButton extends AutofitTextView {
    ...
    public AutoFitCornersButton(Context context) {
        this(context, null, 0);
    }

    public AutoFitCornersButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoFitCornersButton(Context context, AttributeSet attrs, int defStyleAttr) {
